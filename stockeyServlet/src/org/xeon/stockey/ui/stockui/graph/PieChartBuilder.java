...
public class PieChartBuilder {
	...
	public PieChartBuilder addData(Map<String, Double> data) {
		for (String name : data.keySet()) {
			if (dataMap.get(name) == null) {
				...
				configureAddData(new PieChart.Data(name, data.get(name)));
			}
		}
		return this;
	}
	...
	public PieChartBuilder addIndustryData(PieVO pieVO) {
		...
		for (String key : sharedMap.keySet()) {
			...
			PieChart.Data data = new Data(key, shareValue);
	...
	public PieChartBuilder setData(Map<String, Double> dataMap) {
		...
		for (String name : dataMap.keySet()) {
			configureAddData(new PieChart.Data(name, dataMap.get(name)));
		}
		return this;
	}
	...
	private void configureAddData(PieChart.Data data) {
