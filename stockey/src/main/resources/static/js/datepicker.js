...
/**
 * 利用jQuery获得日历的开始时间，并且保存进start-time的input value中
 */
function getStartTime() {
    var startTime = $(".drp-calendar-start").find(".drp-calendar-date").text();
...
/**
 * 利用jQuery获得日历的结束时间，并且保存进end-time的input value中
 */
function getEndTime() {
    var endTime = $(".drp-calendar-end").find(".drp-calendar-date").text();
