...
public interface StockAnalysisService {
    ...
    Collection<CandlestickVO> getCandlestickLineD(Collection<DailyDataVO> dailyDataVOs, LocalDate begin, LocalDate end)
    ...
    double getVarianceOfChangeD(Collection<DailyDataVO> dailyVOs, LocalDate begin, LocalDate end) throws NetworkConnectionException;
     ...
     * @return 指定股票的评价
     */
    String getComment(String stockCode) throws NetworkConnectionException;
     ...
     * @throws NetworkConnectionException
     */
    QuotaVO getStockQuota(String stockCode) throws NetworkConnectionException;

    /**
     * 获得两只股票的距离
     * @param stockCode 股票代码
     * @param otherStock    股票代码
     * @return  距离值
     * @throws NetworkConnectionException
     */
    double getDistance(String stockCode, String otherStock) throws NetworkConnectionException;
     ...
     * @throws NetworkConnectionException
     */
    Collection<QuotaVO> getStockQuotas(List<String> codes) throws NetworkConnectionException;
     ...
     * @throws NetworkConnectionException
     */
    Collection<QuotaVO> getClosestQuota(String stockCode) throws NetworkConnectionException;
     ...
     * @return
     */
    boolean setPercentage(VectorVO percentage, QuotaVO target);
}
