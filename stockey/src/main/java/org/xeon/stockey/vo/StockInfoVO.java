...
public class StockInfoVO implements Serializable
{
    ...
    {
        this(po.getSymbol(), po.getName(), po.getInfo(), ExchangeEnum.valueOf(po.getMarket()), po.getRegion(), po.getType());
        DailyDataPO latestPO = stockDataService.getLatestDailyData(po.getSymbol());
        this.latestDailyDataVO = latestPO == null ? null : new DailyDataVO(latestPO);
    }
