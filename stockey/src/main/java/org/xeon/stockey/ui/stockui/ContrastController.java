...
public class ContrastController {
	...
	private StockSourceService benchmarkSource = new DBStockSourceImpl();
...
//			allStocks.addAll(benchmarkSource.getAllStockInfo());
	...
	public static Pane launch(Pane parent) throws IOException {
		...
		FXMLLoader loader = new FXMLLoader(
				ContrastController.class.getResource("Contrast.fxml"));
	...
	private void setLineChart(StockInfoVO stock)
		...
		LocalDate lastDate = stockSource.getLatestDailyData(stock.getStockCode()).getDate();
		Collection<PointVO> pointVOs = stockAnalysisService.getTrendD(
				stock.getStockCode(), lastDate.minusDays(7),
				lastDate);
